...
public class StarterTestsMod {
	...
	public void test_getElementsOfRanks_1() {
		TreeNode<Integer> n1 = new TreeNode<>(1123);
		TreeNode<Integer> n2 = new TreeNode<>(1146);
		TreeNode<Integer> n3 = new TreeNode<>(1169);
		TreeNode<Integer> n4 = new TreeNode<>(1192);
		TreeNode<Integer> n5 = new TreeNode<>(1215);
		TreeNode<Integer> n6 = new TreeNode<>(1238);
		TreeNode<Integer> n7 = new TreeNode<>(1261);
		...
		assertTrue(output.getElement() == 1123);
		assertNull(output.getNext());
		
		output = u.getElementsOfRanks(n2, 4, 4);
		assertTrue(output.getElement() == 1192);
		assertNull(output.getNext());
		
		output = u.getElementsOfRanks(n2, 7, 7);
		assertTrue(output.getElement() == 1261);
		assertNull(output.getNext());
	}
	...
	public void test_getElementsOfRanks_2() {
		...
		assertTrue(output.getElement() == 1123);
		assertTrue(output.getNext().getElement() == 1146);
		assertNull(output.getNext().getNext());
		
		output = u.getElementsOfRanks(n2, 4, 5);
		assertTrue(output.getElement() == 1192);
		assertTrue(output.getNext().getElement() == 1215);
		assertNull(output.getNext().getNext());
		
		output = u.getElementsOfRanks(n2, 6, 7);
		assertTrue(output.getElement() == 1238);
		assertTrue(output.getNext().getElement() == 1261);
		assertNull(output.getNext().getNext());
	}
	...
	public void test_getElementsOfRanks_3() {
		...
		assertTrue(output.getElement() == 1123);
		assertTrue(output.getNext().getElement() == 1146);
		assertTrue(output.getNext().getNext().getElement() == 1169);
		assertNull(output.getNext().getNext().getNext());
		
		output = u.getElementsOfRanks(n2, 3, 5);
		assertTrue(output.getElement() == 1169);
		assertTrue(output.getNext().getElement() == 1192);
		assertTrue(output.getNext().getNext().getElement() == 1215);
		assertNull(output.getNext().getNext().getNext());
		
		output = u.getElementsOfRanks(n2, 5, 7);
		assertTrue(output.getElement() == 1215);
		assertTrue(output.getNext().getElement() == 1238);
		assertTrue(output.getNext().getNext().getElement() == 1261);
		assertNull(output.getNext().getNext().getNext());
	}
	...
	public void test_getElementsOfRanks_4() {
		...
		assertTrue(output.getNext().getElement() == 1146);
		assertTrue(output.getNext().getNext().getElement() == 1169);
		assertTrue(output.getNext().getNext().getNext().getElement() == 1192);
		assertTrue(output.getNext().getNext().getNext().getNext().getElement() == 1215);
		assertTrue(output.getNext().getNext().getNext().getNext().getNext().getElement() == 1238);
		assertTrue(output.getNext().getNext().getNext().getNext().getNext().getNext().getElement() == 1261);
	...
	public void test_getStats_1() {
		...
		assertEquals("Number of descendants: 4; Sum of descendants: 4745", output.getElement());
		...
		assertEquals("Number of descendants: 1; Sum of descendants: 1123", levelOneChild0.getElement());
		/* child 1 */
		assertTrue(output == levelOneChild1.getParent());
		assertEquals("Number of descendants: 1; Sum of descendants: 1215", levelOneChild1.getElement());
		/* child 2 */
		assertTrue(output == levelOneChild2.getParent());
		assertEquals("Number of descendants: 1; Sum of descendants: 1261", levelOneChild2.getElement());
	...
	public void test_getStats_2() {
		...
		assertEquals("Number of descendants: 1; Sum of descendants: 1123", output.getElement());
	}
	...
	public void test_getStats_3() {
		...
		TreeNode<String> output = u.getStats(n2);
		assertNull(output.getParent());
		assertEquals("Number of descendants: 7; Sum of descendants: 8344", output.getElement());
		...
		/* child 0 */
		assertTrue(output == levelOneChild0.getParent());
		assertEquals("Number of descendants: 3; Sum of descendants: 3484", levelOneChild0.getElement());
		/* child 1 */
		assertTrue(output == levelOneChild1.getParent());
		assertEquals("Number of descendants: 2; Sum of descendants: 2453", levelOneChild1.getElement());
		/* child 2 */
		assertTrue(output == levelOneChild2.getParent());
		assertEquals("Number of descendants: 1; Sum of descendants: 1261", levelOneChild2.getElement());
		...
		assertEquals("Number of descendants: 1; Sum of descendants: 1192", levelTwoChild0.getElement());
		/* child 1 */
		assertTrue(levelOneChild0 == levelTwoChild1.getParent());
		assertEquals("Number of descendants: 1; Sum of descendants: 1169", levelTwoChild1.getElement());
		/* child 2 */
		assertTrue(levelOneChild1 == levelTwoChild2.getParent());
		assertEquals("Number of descendants: 1; Sum of descendants: 1238", levelTwoChild2.getElement());
